...
If you want to hide `Ok` and `Cancel` buttons, you simply set this parameter to `true`. By doing that you can recive a closer function when calling Alert,Ask or Dialogue.
