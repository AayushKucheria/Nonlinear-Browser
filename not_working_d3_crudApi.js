...
//   console.log("New tab: ", tabObj, " with root: ", window.currentRoot);
...
//
//   if(displayChanged) {
//     console.log("Updating tab: ", updatedTab, " with root: ", window.currentRoot);
//     drawTree(window.currentRoot);
//   }
// }
//
...
//
//   // parent.data.children = parent.data.children.filter(d => d.id != tabId);
//   parent.data.children = parent.data.children.filter(d => d != removedTab.data);
//   mapping.delete(tabId);
//   console.log("Removing tab: ", removedTab, " with root: ", window.currentRoot);
//   drawTree(window.currentRoot);
// }
//
